    ...
    while (vm->pc < gen->code_size) {
        ...
        switch (instr.opcode) {
            ...
            case OP_LOAD: {
                ...
                if (vm->fp + offset >= vm->stack_size) {
                    fprintf(stderr, "Stack access out of bounds\n");
                    exit(1);
                }
            ...
            case OP_STORE: {
                ...
                if (vm->fp + offset >= vm->stack_capacity) {
                    fprintf(stderr, "Stack access out of bounds in STORE\n");
                    exit(1);
                }
