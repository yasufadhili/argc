...
typedef struct Symbol {
    ...
    char *type;
    SymbolKind kind;
    int offset;  // offset field for variable location in memory
    struct Symbol *next;
} Symbol;
 ...
 * CODE GENERATION
 *
 * The code generator converts the AST into target code. Uses a Vitual Machine
 */
